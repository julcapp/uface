...
import faceelook from "../../images/faceelook.svg";
        ...
        <div className={css.base_container}>
            ...
            <div className={css.content}>
                ...
                <div className={css.log_in}>
                    <div>
                        <a href="https://uface.su/persident/tgulogin"
                            className={css.log_in_with}>Войти по ТГУ.Аккаунты
                        </a>
                    </div>
                    <div className={css.log_in_cber}>
                        <img className={css.sber_icon} src={sber_icon} alt="nophoto" />
                        <a href="#" className={css.log_in_with}>Войти по Сбербанк ID</a>
                    </div>
                </div>
            </div>
        </div>
